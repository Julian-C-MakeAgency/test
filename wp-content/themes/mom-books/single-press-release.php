		...
		<div class="m-auto max-w-8xl px-4 sm:px-8 xl:px-14 py-24">
			<div class="w-full md:max-w-5xl px-2 sm:px-6 xl:px-7 m-auto">
				<div class="w-full">
					...
					if ( get_the_content() ) {
						echo '<div class="max-w-full text-sky-900 mb-6 [&_img.alignleft]:float-left [&_img.alignleft]:my-0 [&_img.alignleft]:pr-4 [&_img.alignleft]:pb-4  [&_ul]:list-disc [&_ol]:list-decimal prose-hr:border-sky-900 prose-lg prose-headings:text-sky-900 prose-headings:font-medium [&_ul]:list-disc [&_ol]:list-decimal prose-h2:text-3xl">';
						if ( $image ) {
